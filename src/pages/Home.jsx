  ...
  const serviceCategories = [
    {
      ...
      eyebrow: '[04-A]',
      services: [
        { icon: <Globe size={24} className="text-[#00FF66]" />, title: 'Static Website', desc: 'Landing pages, portfolios — fast, responsive, SEO-optimized.', price: 'Starting ₹30,000', tags: ['HTML/CSS', 'REACT', 'RESPONSIVE'] },
        { icon: <Server size={24} className="text-[#00FF66]" />, title: 'Dynamic Website', desc: 'Full-stack apps with admin panels, auth, and database.', price: 'Starting ₹50,000', tags: ['NODE.JS', 'CMS', 'DATABASE'] },
        { icon: <Database size={24} className="text-[#00FF66]" />, title: 'Large-Scale / Custom Software', desc: 'Microservices, e-commerce platforms, SaaS products.', price: 'Starting ₹1,00,000', tags: ['MICROSERVICES', 'KAFKA', 'DOCKER'] },
      ]
    },
    {
      ...
      eyebrow: '[04-B]',
      services: [
        { icon: <Megaphone size={24} className="text-[#00FF66]" />, title: 'Social Media Management', desc: 'Content strategy, scheduling, analytics & growth.', price: 'Starting ₹8,000/mo', tags: ['CONTENT', 'SCHEDULING', 'ANALYTICS'] },
        { icon: <Target size={24} className="text-[#00FF66]" />, title: 'Advanced SEO & Growth Setup', desc: 'Technical SEO audit, keyword strategy, and data-driven marketing funnel optimization.', price: 'Starting ₹15,000', tags: ['SEO', 'DATA LAYER', 'GROWTH'] },
        { icon: <BarChart3 size={24} className="text-[#00FF66]" />, title: 'Ad Campaign Management', desc: 'Google Ads, Meta Ads — strategy, optimization, reporting.', price: '% of ad spend or flat fee', tags: ['GOOGLE ADS', 'META ADS', 'ROI'] },
      ]
    },
    {
      category: 'SEO',
      eyebrow: '[04-C]',
      services: [
        { icon: <Search size={24} className="text-[#00FF66]" />, title: 'On-Page SEO Audit', desc: 'Keyword analysis, meta optimization, content recommendations.', price: 'One-time ₹5,000', tags: ['KEYWORDS', 'META TAGS', 'CONTENT'] },
        { icon: <Zap size={24} className="text-[#00FF66]" />, title: 'Technical SEO', desc: 'Core Web Vitals, schema markup, site speed optimization.', price: 'Starting ₹10,000', tags: ['CORE WEB VITALS', 'SCHEMA', 'SPEED'] },
        { icon: <LineChart size={24} className="text-[#00FF66]" />, title: 'Monthly SEO Retainer', desc: 'Ongoing optimization, link building, ranking reports.', price: 'Starting ₹8,000/mo', tags: ['LINK BUILDING', 'RANKINGS', 'REPORTS'] },
      ]
    }
  ];
  ...
  return (
    <div className="bg-[#090a0a] min-h-screen text-white relative">
      ...
      >
        ...
        {/* Radial light */}
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[800px] h-[800px] bg-[#00FF66]/10 rounded-full blur-[150px] pointer-events-none z-0"></div>
        ...
        <div className="max-w-[1500px] mx-auto w-full px-4 md:px-8 lg:px-12 flex flex-col relative z-10 pt-28 pb-10">
          ...
          <div className="w-full lg:w-2/3 flex flex-col justify-center relative z-20 mt-6 lg:mt-0">
            ...
            <h1 className="text-[28px] sm:text-[36px] md:text-[50px] lg:text-[46px] font-bold leading-[1.2] tracking-tight mb-8">
              ...
              <span className="font-serif tracking-[-0.025em] px-[0.04em] italic font-normal text-[#00FF66] relative inline-block">
                apps & scale your
                <svg className="absolute w-[110%] h-[12px] -bottom-[4px] -left-[5%] text-[#00FF66]" viewBox="0 0 200 15" fill="none">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mb-12 w-full sm:w-auto">
              ...
              <Link to="/works" className="w-full sm:w-auto bg-[#151515] hover:bg-[#1a1a1a] transition-all duration-300 hover:scale-[1.02] sm:hover:scale-105 border border-white/5 rounded-sm px-6 sm:px-8 py-4 flex items-center justify-center group">
                <div className="w-[6px] h-[6px] bg-[#00FF66] mr-3 rounded-sm group-hover:scale-125 transition-transform shadow-[0_0_8px_rgba(0,255,102,0.5)]"></div>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-8 border-t border-white/10 mt-auto">
              <div className="flex items-center">
                <div className="text-[#00FF66] mr-2 font-bold text-[13px]">⚡</div>
          ...
          {[
            {
              id: '01',
              title: 'Websites',
              icon: <LayoutTemplate size={24} className="text-[#00FF66]" />,
            ...
            },
            {
              ...
              icon: <Server size={24} className="text-[#00FF66]" />,
            ...
            },
            {
              ...
              icon: <Code2 size={24} className="text-[#00FF66]" />,
            ...
            },
            {
              id: '04',
              title: 'Mobile Apps',
              icon: <Smartphone size={24} className="text-[#00FF66]" />,
            ...
            },
            {
              id: '05',
              title: 'UI/UX Design',
              icon: <PenTool size={24} className="text-[#00FF66]" />,
            ...
            },
            {
              id: '06',
              title: 'SEO & Marketing',
              icon: <TrendingUp size={24} className="text-[#00FF66]" />,
            ...
            <div key={card.id} className="bg-[#111212] border border-white/5 rounded-sm p-8 md:p-12 relative overflow-hidden group cursor-pointer hover:border-white/10 transition-all duration-300 hover:scale-[1.02]">
              ...
              <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-[#00FF66]/10 rounded-full blur-[100px] opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
              ...
              {/* Icon Box */}
              <div className="w-12 h-12 border border-[#00FF66]/30 bg-[#00FF66]/5 flex items-center justify-center rounded-sm mb-12 relative z-10">
                {card.icon}
              </div>
                ...
                <div className="flex flex-wrap gap-2 max-w-[90%]">
                  {card.tags.map((tag, idx) => (
                    <div key={idx} className="flex items-center space-x-2 bg-white/5 border border-white/5 px-3 py-1.5 rounded-sm">
                      <div className="w-2.5 h-2.5 border border-[#00FF66]/50 rounded-sm"></div>
                      <span className="font-mono text-[9px] tracking-[0.1em] text-white/70 uppercase">{tag}</span>
                    </div>
                  ))}
                </div>
                <ArrowRight size={16} className="text-white/30 group-hover:text-[#00FF66] transition-colors group-hover:translate-x-1" />
              </div>
      ...
      <section className="max-w-[1500px] mx-auto w-full px-4 md:px-8 lg:px-12 pb-16 pt-10 relative z-10">
        ...
        <h2 className="text-[28px] md:text-[38px] lg:text-[46px] font-bold tracking-tight mb-16">
          What we've <span className="font-serif tracking-[-0.025em] px-[0.04em] italic font-normal text-[#00FF66]">built.</span>
        </h2>
          ...
          {[
            ...
            <Link to={`/works/${project.num}`} key={project.num} className="flex flex-col md:flex-row items-start md:items-center justify-between py-6 md:py-8 border-b border-white/10 group cursor-pointer hover:bg-white/[0.02] transition-colors px-4 -mx-4 rounded-sm">
              <div className="flex items-center space-x-8 md:space-x-12 mb-4 md:mb-0">
                <span className="font-mono text-[9px] text-white/40 group-hover:text-[#00FF66] transition-colors">{project.num}</span>
                <h3 className="text-[18px] md:text-[24px] font-bold tracking-tight group-hover:text-[#00FF66] transition-colors">{project.title}</h3>
              </div>
              <div className="flex items-center space-x-6 md:space-x-10 text-white/40 font-mono text-[9px] tracking-[0.1em] uppercase ml-12 md:ml-0">
                ...
                <span className="text-[#00FF66] transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform">↗</span>
              </div>
            </Link>
          ))}
        </div>
      ...
      <section id="services" className="max-w-[1500px] mx-auto w-full px-4 md:px-8 lg:px-12 pb-16 pt-4 relative z-10">
        ...
        {serviceCategories.map((cat, catIdx) => (
          <div key={catIdx} className="mb-10 last:mb-0">
            {/* Category Title */}
            <div className="flex items-center space-x-3 mb-6">
              <span className="font-mono text-[14px] md:text-[16px] font-bold tracking-[0.15em] text-[#00FF66] uppercase">
                {cat.category}
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {cat.services.map((service, sIdx) => (
                <div key={sIdx} className="bg-[#111212] border border-white/5 rounded-sm p-8 md:p-10 relative overflow-hidden group hover:border-white/10 transition-all duration-300 hover:scale-[1.02] flex flex-col">
                  ...
                  {/* Radial glow */}
                  <div className="absolute top-0 right-0 w-[250px] h-[250px] bg-[#00FF66]/10 rounded-full blur-[80px] opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>

                  {/* Icon */}
                  <div className="w-12 h-12 border border-[#00FF66]/30 bg-[#00FF66]/5 flex items-center justify-center rounded-sm mb-8 relative z-10">
                    {service.icon}
                  </div>
                  ...
                  <div className="flex items-center mb-8 relative z-10">
                    <span className="text-[#00FF66] font-bold text-[18px]">{service.price}</span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-8 relative z-10">
                    {service.tags.map((tag, tIdx) => (
                      <div key={tIdx} className="flex items-center space-x-1.5 bg-white/5 border border-white/5 px-2.5 py-1 rounded-sm">
                        <div className="w-2 h-2 border border-[#00FF66]/50 rounded-sm"></div>
                  ...
                  <div className="mt-auto relative z-10">
                    ...
                    <button
                      ...
                      className="flex items-center text-[13px] font-medium text-white/70 group-hover:text-[#00FF66] transition-colors"
                    >
      ...
      <section id="about" className="max-w-[1500px] mx-auto w-full px-4 md:px-8 lg:px-12 pb-16 pt-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 relative w-full aspect-[4/5] md:aspect-square lg:aspect-[4/5] group mx-auto md:max-w-[70%] lg:max-w-none flex items-center justify-center">
            ...
            <div className="absolute w-[80%] h-[80%] rounded-full bg-gradient-to-tr from-[#00FF66]/20 to-[#00FF66]/40 blur-[80px] opacity-80 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none z-0"></div>
          ...
          <div className="lg:col-span-7 flex flex-col">
            ...
            <h2 className="text-[28px] md:text-[38px] lg:text-[46px] font-bold tracking-tight leading-[1.0] mb-8">
              AKY <br />
              <span className="font-serif tracking-[-0.025em] px-[0.04em] italic font-normal text-[#00FF66]">Technologies.</span>
            </h2>

            {/* Tags */}
            <div className="flex flex-wrap gap-3 mb-10">
              <div className="flex items-center space-x-2 bg-[#111212] border border-white/5 px-4 py-2 rounded-sm">
                <span className="text-[#00FF66] text-[12px] font-mono leading-none">⭐</span>
                <span className="font-mono text-[10px] tracking-[0.1em] text-white/70 uppercase pt-0.5">TECH AGENCY</span>
              </div>
              <div className="flex items-center space-x-2 bg-[#111212] border border-white/5 px-4 py-2 rounded-sm">
                <Code size={12} className="text-[#00FF66]" />
            ...
            <p className="text-white/70 text-[15px] leading-relaxed max-w-[480px] mb-4">
              Engineering-led agency — turning complex ideas into high-performance <span className="text-[#00FF66] italic font-serif text-[17px] tracking-[-0.02em] px-[0.04em]">production systems.</span>
            </p>
            ...
            <button
              ...
              className="w-fit mb-16 bg-[#00FF66] hover:bg-[#33ff85] text-[#090a0a] font-bold text-[14px] px-8 py-4 rounded-sm transition-all duration-300 hover:scale-105 shadow-[0_0_20px_rgba(0,255,102,0.3)] hover:shadow-[0_0_30px_rgba(0,255,102,0.5)]"
            >
              Get a Quote →
            </button>
            ...
            <div className="grid grid-cols-2">
              <div className="border-t border-r border-white/10 p-6 md:p-8 flex justify-between items-start group hover:bg-white/[0.02] transition-colors">
                <div className="flex flex-col">
                  <span className="text-[32px] md:text-[40px] font-bold leading-none mb-2 tracking-tight">1<span className="text-[#00FF66]">+</span></span>
                  <span className="font-mono text-[9px] tracking-[0.2em] text-white/40 uppercase">YEARS EXPERIENCE</span>
                </div>
                <div className="w-6 h-6 border border-white/10 rounded-sm flex items-center justify-center bg-white/5 text-[#00FF66] group-hover:bg-[#00FF66]/10 transition-colors">
                  <Clock size={10} />
                </div>
              </div>
              ...
              <div className="border-t border-white/10 p-6 md:p-8 flex justify-between items-start group hover:bg-white/[0.02] transition-colors">
                <div className="flex flex-col">
                  <span className="text-[32px] md:text-[40px] font-bold leading-none mb-2 tracking-tight">3<span className="text-[#00FF66]">+</span></span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8">
          ...
          <div className="flex flex-col">
            <h2 className="text-[36px] md:text-[48px] lg:text-[56px] font-bold tracking-tight mb-8 leading-[1.0]">
              Let's <span className="font-serif tracking-[-0.025em] px-[0.04em] italic font-normal text-[#00FF66]">talk.</span>
            </h2>
            ...
            <div className="flex flex-col mb-16">
              <div className="flex flex-col sm:flex-row sm:items-center py-6 border-t border-white/10">
                ...
                <a href="mailto:amityadav63999@gmail.com" className="font-medium text-[15px] hover:text-[#00FF66] transition-colors">amityadav63999@gmail.com</a>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center py-6 border-t border-white/10">
                <span className="w-32 font-mono text-[10px] tracking-[0.1em] text-white/50 uppercase mb-2 sm:mb-0">Phone</span>
                <a href="tel:+918948869211" className="font-medium text-[15px] hover:text-[#00FF66] transition-colors">+91 8948869211</a>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center py-6 border-t border-white/10">
          ...
          <div className="bg-[#111212] border border-white/5 rounded-sm p-8 md:p-12">
            ...
            <h3 className="text-[22px] md:text-[26px] font-bold tracking-tight mb-10">
              Send a <span className="font-serif tracking-[-0.025em] px-[0.04em] italic font-normal text-[#00FF66]">short briefing.</span>
            </h3>
              ...
              <form className="flex flex-col space-y-6" onSubmit={handleFormSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col space-y-2">
                    ...
                    <input type="text" name="firstName" value={formData.firstName} onChange={handleFormChange} placeholder="Your name" className="bg-[#1a1b1b] border border-white/5 text-white text-[14px] px-4 py-3 rounded-sm focus:outline-none focus:border-[#00FF66]/50 transition-colors placeholder-white/30" required disabled={formStatus === 'loading'} />
                  </div>
                  <div className="flex flex-col space-y-2">
                    <label className="font-mono text-[9px] tracking-[0.1em] text-white/50 uppercase flex items-center">
                      LAST NAME <span className="text-[#00FF66] ml-1">*</span>
                    </label>
                    <input type="text" name="lastName" value={formData.lastName} onChange={handleFormChange} placeholder="Last name" className="bg-[#1a1b1b] border border-white/5 text-white text-[14px] px-4 py-3 rounded-sm focus:outline-none focus:border-[#00FF66]/50 transition-colors placeholder-white/30" required disabled={formStatus === 'loading'} />
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <input type="email" name="email" value={formData.email} onChange={handleFormChange} placeholder="you@company.com" className="bg-[#1a1b1b] border border-white/5 text-white text-[14px] px-4 py-3 rounded-sm focus:outline-none focus:border-[#00FF66]/50 transition-colors placeholder-white/30" required disabled={formStatus === 'loading'} />
                </div>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <input type="tel" name="phone" value={formData.phone} onChange={handleFormChange} placeholder="+91 1234567890" className="bg-[#1a1b1b] border border-white/5 text-white text-[14px] px-4 py-3 rounded-sm focus:outline-none focus:border-[#00FF66]/50 transition-colors placeholder-white/30" required disabled={formStatus === 'loading'} />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col space-y-2">
                    ...
                    <input type="text" name="company" value={formData.company} onChange={handleFormChange} placeholder="Your Company" className="bg-[#1a1b1b] border border-white/5 text-white text-[14px] px-4 py-3 rounded-sm focus:outline-none focus:border-[#00FF66]/50 transition-colors placeholder-white/30" disabled={formStatus === 'loading'} />
                  </div>
                  <div className="flex flex-col space-y-2">
                    <label className="font-mono text-[9px] tracking-[0.1em] text-white/50 uppercase flex items-center">
                      CURRENT WEBSITE <span className="ml-2 lowercase italic opacity-60 font-sans tracking-normal">optional</span>
                    </label>
                    <input type="url" name="website" value={formData.website} onChange={handleFormChange} placeholder="https://your-domain.com" className="bg-[#1a1b1b] border border-white/5 text-white text-[14px] px-4 py-3 rounded-sm focus:outline-none focus:border-[#00FF66]/50 transition-colors placeholder-white/30" disabled={formStatus === 'loading'} />
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <textarea name="message" value={formData.message} onChange={handleFormChange} rows="4" placeholder="Idea, industry, timeline — what I should know." className="bg-[#1a1b1b] border border-white/5 text-white text-[14px] px-4 py-3 rounded-sm focus:outline-none focus:border-[#00FF66]/50 transition-colors placeholder-white/30 resize-none" disabled={formStatus === 'loading'}></textarea>
                </div>

                <div className="flex items-start space-x-3 pt-4">
                  <input type="checkbox" id="inline-privacy" name="privacy" checked={formData.privacy} onChange={handleFormChange} className="mt-0.5 w-4 h-4 bg-[#1a1b1b] border-white/10 rounded-sm focus:ring-[#00FF66] accent-[#00FF66] cursor-pointer" required disabled={formStatus === 'loading'} />
                  <label htmlFor="inline-privacy" className="text-white/60 text-[12px] leading-snug cursor-pointer select-none">
                    I consent to the processing of my data according to the <a href="#" className="text-white hover:text-[#00FF66] underline underline-offset-2 transition-colors">privacy policy</a>.
                  </label>
                </div>
